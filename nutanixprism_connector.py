...
class NutanixPrismConnector(BaseConnector):

    def __init__(self):

        # Call the BaseConnectors init first
        super(NutanixPrismConnector, self).__init__()
    ...
    def _handle_revert_vm(self, param):
    ...
    def _handle_suspend_vm(self, param):
    ...
    def _handle_search_vms(self, param):
    ...
    def _handle_get_snapshot_info(self, param):
    ...
    def handle_action(self, param):
        ...
        elif action_id == 'revert_vm':
            ret_val = self._handle_revert_vm(param)
        ...
        elif action_id == 'suspend_vm':
            ret_val = self._handle_suspend_vm(param)

        elif action_id == 'search_vms':
            ret_val = self._handle_search_vms(param)

        elif action_id == 'list_snapshots':
            ret_val = self._handle_list_snapshots(param)

        elif action_id == 'get_snapshot_info':
            ret_val = self._handle_get_snapshot_info(param)
...
if __name__ == '__main__':
    ...
    with open(args.input_test_json) as f:
        ...
        connector = NutanixPrismConnector()
